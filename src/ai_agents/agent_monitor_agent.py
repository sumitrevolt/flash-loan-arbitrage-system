...
app = FastAPI(title="System Monitoring Agent", version="1.0.0")

class Agent_MonitorAgent:
    """Specialized agent for system monitoring"""
    
    def __init__(self):
        self.name = "agent-monitor"
        self.description = "System Monitoring"
        self.port = 8204
        self.is_active = True
...
async def root():
    """Root endpoint"""
    return {
        "message": "System Monitoring Agent",
        "status": "running",
        "port": 8204,
        "description": "System Monitoring"
    }
