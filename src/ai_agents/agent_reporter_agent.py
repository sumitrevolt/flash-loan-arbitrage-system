...
app = FastAPI(title="Report Generation Agent", version="1.0.0")

class Agent_ReporterAgent:
    """Specialized agent for report generation"""
    
    def __init__(self):
        self.name = "agent-reporter"
        self.description = "Report Generation"
        self.port = 8208
        self.is_active = True
...
async def root():
    """Root endpoint"""
    return {
        "message": "Report Generation Agent",
        "status": "running",
        "port": 8208,
        "description": "Report Generation"
    }
